...
class TrafficLightEnv(object):
    ...
    def __init__(self, queue_length, traffic_rate_upstream, traffic_rate_downstream):
        ...
        # N: 0; S: 1; E: 2; W: 3 for the lane before/after junction array
...
if __name__ == "__main__":
    ...
    Env_input = TrafficLightEnv(queue_length, traffic_rate_upstream, traffic_rate_downstream)
