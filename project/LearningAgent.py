...
class DQNAgent:
    ...
    def __init__(self, state_size, action_size, env, eval_env, unified_config):
        ...
        if self.wandb_testname and self.log_wandb:
    ...
    def evaluate(self, num_episodes=5):
        ...
        for _ in range(num_episodes):
            ...
            for _ in range(self.gym_config['max_simtime']):
                ...
                next_state, reward, done, _, reward_components = self.eval_env.step(action)
...
if __name__ == "__main__":
    ...
    unified_config = {
        ...
        'agent': {
            ...
            'grad_clip': 1.0,
            'min_action_timer': 1,
            'dqn_variant': 'dqn'  # 'dqn', 'double_dqn', 'dueling_dqn', 'double_dueling_dqn'
        },
    ...
    #agent.load("./training/ky-test-31/1000.pth")
